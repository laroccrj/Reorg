...
class Payment
{
  ...
  public function setRecipientPrimaryBusinessStreetAddressLine1(?string $recipient_primary_business_street_address_line1
  ): self {
  ...
  public function setRecipientPrimaryBusinessStreetAddressLine2(?string $recipient_primary_business_street_address_line2
  ): self {
  ...
  public function setSubmittingApplicableManufacturerOrApplicableGpoName(
  ...
  public function setApplicableManufacturerOrApplicableGpoMakingPaymentId(
    ?int $applicable_manufacturer_or_applicable_gpo_making_payment_id
  ): self {
  ...
  public function setApplicableManufacturerOrApplicableGpoMakingPaymentName(
  ...
  public function setApplicableManufacturerOrApplicableGpoMakingPaymentState(
  ...
  public function setApplicableManufacturerOrApplicableGpoMakingPaymentCountry(
  ...
  public function setNameOfThirdPartyEntityReceivingPaymentOrTransferOfVal(
    ?string $name_of_third_party_entity_receiving_payment_or_transfer_of_val
  ): self {
  ...
  public function setThirdPartyEqualsCoveredRecipientIndicator(?string $third_party_equals_covered_recipient_indicator
  ): self {
  ...
  public function setNameOfAssociatedCoveredDrugOrBiological1(?string $name_of_associated_covered_drug_or_biological1
  ): self {
  ...
  public function setNameOfAssociatedCoveredDrugOrBiological2(?string $name_of_associated_covered_drug_or_biological2
  ): self {
  ...
  public function setNameOfAssociatedCoveredDrugOrBiological3(?string $name_of_associated_covered_drug_or_biological3
  ): self {
  ...
  public function setNameOfAssociatedCoveredDrugOrBiological4(?string $name_of_associated_covered_drug_or_biological4
  ): self {
  ...
  public function setNameOfAssociatedCoveredDrugOrBiological5(?string $name_of_associated_covered_drug_or_biological5
  ): self {
  ...
  public function setNdcOfAssociatedCoveredDrugOrBiological1(?string $ndc_of_associated_covered_drug_or_biological1
  ): self {
  ...
  public function setNdcOfAssociatedCoveredDrugOrBiological2(?string $ndc_of_associated_covered_drug_or_biological2
  ): self {
  ...
  public function setNdcOfAssociatedCoveredDrugOrBiological3(?string $ndc_of_associated_covered_drug_or_biological3
  ): self {
  ...
  public function setNdcOfAssociatedCoveredDrugOrBiological4(?string $ndc_of_associated_covered_drug_or_biological4
  ): self {
  ...
  public function setNdcOfAssociatedCoveredDrugOrBiological5(?string $ndc_of_associated_covered_drug_or_biological5
  ): self {
  ...
  public function setNameOfAssociatedCoveredDeviceOrMedicalSupply1(
    ?string $name_of_associated_covered_device_or_medical_supply1
  ): self {
  ...
  public function setNameOfAssociatedCoveredDeviceOrMedicalSupply2(
  ...
  public function setNameOfAssociatedCoveredDeviceOrMedicalSupply3(
  ...
  public function setNameOfAssociatedCoveredDeviceOrMedicalSupply4(
    ?string $name_of_associated_covered_device_or_medical_supply4
  ): self {
  ...
  public function setNameOfAssociatedCoveredDeviceOrMedicalSupply5(
    ?string $name_of_associated_covered_device_or_medical_supply5
  ): self {
